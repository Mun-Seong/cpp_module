...
/*   Updated: 2022/11/03 12:59:47 by museo            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
const char *Bureaucrat::FormIsEmptyExecption::what() const throw() { return "Form is empty :(";}
...
void Bureaucrat::excuteForm(Form const &f) {
	try
	{
		if (&f == nullptr)
			throw Bureaucrat::FormIsEmptyExecption();
